				...
				addShoping:function(e){
					...
					if(dis){
						if ($('#floatOrder').length <= 0) {
							$('body').append('<div id="floatOrder"><img src="images/big/01.jpg" width="50" height="50" /></div');
						};
						var $obj=$('#floatOrder');
						if(!$obj.is(':animated')){
								...
								$obj.stop(false, false).animate({'top': Y-20,'opacity':0},500,function(){
									$obj.fadeOut(300,function(){
										...
										var l=$('.J-shoping-list').length,
											num=Number($num.text());
										if(l<6){
											$body.prepend('<div class="J-shoping-list" data-id="'+id+'"><a href="#"title=""><img src="images/big/pic2.jpg" width="50"height="50"/></a><div class="J-shoping-list-a"><p>V+space国际青创社区</p><p><span class="left"></span><span class="right"><em>3850.00元</em>/月</span></p></div><div class="baseBg J-shoping-close"></div></div>');
										};
										$num.text(num+1);
									});
								});
